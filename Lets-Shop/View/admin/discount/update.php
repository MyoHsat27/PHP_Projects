        ...
        <div class="col-10 right-side p-0">
            <div class="container-fluid navbar ps-0">
                <div class="px-4 py-2 d-flex justify-content-between align-items-center w-100">
                    <div class="fs-4 fw-semibold">Discount / Edit</div>
                </div>
            </div>
            <div class="container d-flex justify-content-center">
                <div class="card form-container">
                    <form action="<?= route('admin/discount-update') ?>" method="post">
                        ...
                        <div class="form-title">Edit Discount</div>
                        <div class="input-container">
                            <label for="name" class="form-label">Name</label>
                            <input type="text" class="form-control" id="name" name="discountName" value="<?= $data->name ?>">
                        </div>
                        <div class="input-container">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control" id="description" rows="3" name="discountDescription"><?= $data->description ?></textarea>
                        </div>
                        <div class="input-container">
                            <label for="percentage" class="form-label">Percentage</label>
                            <input type="text" class="form-control" id="percentage" name="discountPercentage" value="<?= $data->percentage ?>">
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="discountActive" value="active" <?= $data->active_discount ? "checked" : "" ?> id="discount-now">
